...
const defaultSettings: SiteSettings = {
    site_name: 'The Stationery Clinic',
    site_tagline: 'Your Needs, Responded. Premium stationery solutions in Tema and Accra.',
    site_logo: '/profile-logistics-logo.jpg',
    contact_email: 'profilelogistics@gmail.com',
    contact_phone: '0272983503',
    contact_whatsapp: '0272983503',
    contact_address: 'Tema & Accra, Ghana',
    social_facebook: '',
    social_instagram: '',
    social_twitter: '',
    social_tiktok: '',
