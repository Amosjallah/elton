      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex items-center mb-8 px-2 cursor-pointer">
            <span className="text-xl font-bold tracking-tight text-blue-700 uppercase">The Stationery Clinic</span>
            <span className="ml-3 text-sm font-semibold text-gray-400">ADMIN</span>
          </Link>
