...
export default function ContactPage() {
  ...
  const contactEmail = getSetting('contact_email') || 'profilelogistics@gmail.com';
  const contactPhone = getSetting('contact_phone') || '0272983503';
  const contactWhatsapp = getSetting('contact_whatsapp') || '0272983503';
  const contactAddress = getSetting('contact_address') || 'Tema & Accra, Ghana';

  const heroTitle = pageContent?.title || 'Get In Touch';
  const heroSubtitle = pageContent?.subtitle || 'How can we help you today?';
  const heroContent = pageContent?.content || 'The Stationery Clinic team is ready to respond to all your inquiries. Reach out through any of our channels in Tema or Accra.';
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      description: 'Tema & Accra Office'
    }
  ];

  const faqs = [
    {
      question: 'Do you offer delivery to schools and offices?',
      answer: 'Yes! We specialize in responding to the needs of schools and corporate offices with prompt delivery across Tema and Accra.'
    },
    {
      question: 'Can I order stationery in bulk?',
      answer: 'Absolutely. We are an emerging leader in bulk stationery supply. You can use our Bulk Purchase page or contact us directly for a wholesale quote.'
    },
    {
      question: 'Where are you located?',
      answer: 'We are conveniently located to serve both Tema and Accra. Contact us for the specific clinic location nearest to you.'
    }
  ];
            ...
            <form id="contactForm" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  placeholder="Shipping inquiry, quote request, etc."
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your stationery needs..."
                ></textarea>
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-blue-700 to-blue-900 p-8 rounded-2xl text-white">
              ...
              <p className="text-blue-100 mb-6 leading-relaxed">
                Our support team is available Monday to Friday, 8am-6pm GMT. For urgent matters, reach out via WhatsApp.
              </p>
              <a
                href={waLink}
                target="_blank"
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Base</h2>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Serving our clients from our hubs in Tema and Accra. We respond to all your requests with professional care and speed.
            </p>
