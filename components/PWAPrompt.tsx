          ...
          <div className="px-6 pb-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-gray-900 text-lg truncate">PROFILE LOGISTICS</h3>
                <p className="text-sm text-gray-500">profilelogistics.com</p>
                <div className="flex items-center gap-1 mt-1">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <i key={star} className="ri-star-fill text-amber-400 text-xs" />
                  ))}
                  <span className="text-xs text-gray-400 ml-1">Logistics</span>
                </div>
              </div>
            </div>
