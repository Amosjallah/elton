...
export default function Footer() {
  ...
  const siteTagline = getSetting('site_tagline') || 'The Stationery Clinic – Emerging stationery solutions in Tema and Accra.';
  ...
  const siteLogo = getSetting('site_logo') || '/profile-logistics-logo.jpg';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <p className="text-blue-200/60 leading-relaxed text-sm">
                {siteTagline} Accra, Ghana. Call {contactPhone} · WhatsApp {contactWhatsapp}
              </p>
            ...
            <div className="lg:col-span-3 grid md:grid-cols-3 gap-8 lg:gap-12 pl-0 lg:pl-12">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-blue-100/60 text-sm">
                  ...
                  <li><Link href="/bulk-purchase" className="hover:text-blue-300 transition-colors">Bulk Purchase</Link></li>
