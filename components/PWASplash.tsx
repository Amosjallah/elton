...
export default function PWASplash() {
  ...
  return (
    <div className="pwa-splash" aria-hidden="true">
      ...
      <h1 className="text-white text-xl font-bold mb-2">PROFILE LOGISTICS</h1>
      <p className="text-blue-200 text-sm font-medium mb-8">Fast & Reliable Logistics Solutions</p>
